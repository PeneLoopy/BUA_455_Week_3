...
bom22 <- read_csv("code_data_output/box_office_mojo_2022.csv", skip=11, show_col_types = FALSE) |>
  filter(!is.na(Day)) |>
...
write_csv(mojo_22_fall_wknd, "Movie_Gross_Fall_2022_Weekends_Max_Gargurevich.csv")

# export summary dataset using write_csv with piping
mojo_22_fall_wknd |>
  write_csv("Movie_Gross_Fall_2022_Weekends_Max_Gargurevich.csv")
